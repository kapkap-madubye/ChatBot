...
const responses = {
    ...
    Default: [
        "I'm afraid I don't have an answer for that. You can ask me about kapkap or jokes surely i can make you laugh!",
    ],
    Description:[
        "A very good programmer.",
        "He Graduated from University of Johannesburg",
        "He is Action oriented and pay attention to details",
        "He is proficient in JavaScript, Python, C#, C++, React, SQL",
        "He is passionate about Technology!",
        "He is commercially aware.", 
        "He has love for sport, a big Chelsea fan."
    ],
    Joke: [
...
sendButton.addEventListener("click", () => {
    if (input.value !== "") {
        ...
        if (inputText.includes("hello") || inputText.includes("hi")) {
            ...
            intent = "Joke";
        }else if (inputText.includes("kapkap")){
            intent="Description";
        }
